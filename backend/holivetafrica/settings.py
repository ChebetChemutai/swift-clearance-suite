...
ROOT_URLCONF = "holivetafrica.urls"
...
WSGI_APPLICATION = "holivetafrica.wsgi.application"
ASGI_APPLICATION = "holivetafrica.asgi.application"

DATABASES = {
    "default": {
        "ENGINE": os.environ.get("DJANGO_DB_ENGINE", "django.db.backends.postgresql"),
        "NAME": os.environ.get("POSTGRES_DB", os.environ.get("DB_NAME", "holivetafrica")),
